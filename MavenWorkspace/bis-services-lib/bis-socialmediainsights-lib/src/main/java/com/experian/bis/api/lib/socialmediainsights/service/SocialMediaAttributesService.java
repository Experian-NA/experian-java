package com.experian.bis.api.lib.socialmediainsights.service;
...
public class SocialMediaAttributesService {
	private static final String SERVICE_ID = "attributes";
	 ...
	 */
	public SocialMediaAttributesService() {
	}

	/**
	 * Constructor with {@link BISServiceCredential} param type
	 * 
	 * @param serviceCredential
	 */
	public SocialMediaAttributesService(BISServiceCredential serviceCredential) {
		this.serviceCredential = serviceCredential;
	}

	/**
	 * Constructor with {@link BISServiceCredential} and {@link java.net.Proxy}
	 * param type
	 * 
	 * @param serviceCredential
	 * @param proxy
	 */
	public SocialMediaAttributesService(BISServiceCredential serviceCredential, Proxy proxy) {
		this.serviceCredential = serviceCredential;
		this.proxy = proxy;
	}
	...
	/**
	 * This method constructs the String Business Service request (in JSON
	 * format) from the given {@link SocialMediaRequest} param
	 * 
	 * @param socialMediaRequest
	 * @return
	 * @throws BISServiceException
	 */
	protected String constructPostRequestBody(SocialMediaAttributesRequest socialMediaRequest)
			throws BISServiceException {
		ObjectMapper mapper = new ObjectMapper();
		try {
			return mapper.writeValueAsString(socialMediaRequest);
	...
	/**
	 * Returns the URL of this Business Service. The returned value is dependent
	 * on the Service Class and Environment. The value is read from
	...
	protected String getServiceUrl() throws BISServiceException {
		...
		rBundle = ResourceBundle.getBundle("smi-config");
		/*Enumeration<String> it = rBundle.getKeys();
		while(it.hasMoreElements()) {
			String key = it.nextElement();
			System.out.println(key+":"+rBundle.getString(key));
		}*/
	...
	/**
	 * Returns a Map<String, String> of common request headers required to
	 * invoke Business Services APIs
	 * 
	 * @return
	 */
	...
	/**
	 * This is one of the most important methods of BusinessService class. This
	 * method actually makes a REST call to the Experian Service based on the
	...
	/**
	 * This class returns an appropriate Custom Exception for any kind of
	 * Service Failure
	 * 
	 * @param rawResponse
	 * @param conn
	...
	/**
	 * Converts the JSON formatted response stored in rawServiceResponse to the
	 * Java object of the Class, passed as parameter of this method
	 * 
	 * @param type
	 * @return
	 * @throws BISServiceException
	...
	protected Object parseResponseToObject(Class type) throws BISServiceException {
		...
		try {
			...
			obj = type.cast(mapper.readValue(apiResponse, type));
		} catch (Exception e) {
	...
	public SocialMediaAttributesResponse execute(SocialMediaAttributesRequest socialMediaRequest) throws BISServiceException {
		SocialMediaAttributesRequest request = (SocialMediaAttributesRequest) socialMediaRequest;
		...
		SocialMediaAttributesResponse response = (SocialMediaAttributesResponse) parseResponseToObject(
				SocialMediaAttributesResponse.class);
		return response;
	}
