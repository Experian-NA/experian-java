...
import com.experian.bis.api.lib.businessservices.bean.request.TradesServiceRequest;
import com.experian.bis.api.lib.businessservices.bean.response.BusinessServiceResponse;
import com.experian.bis.api.lib.businessservices.bean.response.TradesServiceResponse;
...
/**
 * <code>TradesService</code> is the child class of BusinessService
 * Class for building the url and response body
 */
public class TradesService extends BusinessService{
	private static final String SERVICE_ID = "trades";
	 ...
	 */
	public TradesService(BISServiceCredential serviceCredential) {
	 ...
	 * @param proxy
	 */
	public TradesService(Proxy proxy) {
		super(proxy);
	}
	 ...
	 */
	public TradesService(BISServiceCredential serviceCredential, Proxy proxy) {
	...
	public BusinessServiceResponse execute(BusinessServiceRequest businessServiceRequest) throws BISServiceException {
		TradesServiceRequest request = (TradesServiceRequest) businessServiceRequest;
		...
		TradesServiceResponse response = (TradesServiceResponse) parseResponseToObject(TradesServiceResponse.class);
		return response;
	}
