...
import com.experian.bis.api.lib.businessservices.bean.request.ScoresSearchServiceRequest;
import com.experian.bis.api.lib.businessservices.bean.response.BusinessServiceResponse;
import com.experian.bis.api.lib.businessservices.bean.response.ScoresSearchServiceResponse;
...
public class ScoresSearchService extends BusinessService{
	
	private static final String SERVICE_ID = "scores/search";
	 ...
	 */
	public ScoresSearchService(BISServiceCredential serviceCredential) {
	 ...
	 * @param proxy
	 */
	public ScoresSearchService(Proxy proxy) {
		super(proxy);
	}
	 ...
	 */
	public ScoresSearchService(BISServiceCredential serviceCredential, Proxy proxy) {
	...
	public BusinessServiceResponse execute(BusinessServiceRequest businessServiceRequest) throws BISServiceException {
		ScoresSearchServiceRequest request = (ScoresSearchServiceRequest) businessServiceRequest;
		...
		ScoresSearchServiceResponse response = (ScoresSearchServiceResponse) parseResponseToObject(ScoresSearchServiceResponse.class);
		return response;
	}
