...
import com.experian.bis.api.lib.businessservices.bean.request.HeadersServiceRequest;
import com.experian.bis.api.lib.businessservices.bean.request.BusinessServiceRequest;
import com.experian.bis.api.lib.businessservices.bean.response.HeadersServiceResponse;
...
/**
 * <code>HeadersService</code> is the child class of BusinessService
 * Class for building the url and response body
 */
public class HeadersService extends BusinessService{
	private static final String SERVICE_ID = "headers";
	 ...
	 */
	public HeadersService(BISServiceCredential serviceCredential) {
	 ...
	 * @param proxy
	 */
	public HeadersService(Proxy proxy) {
		super(proxy);
	}
	 ...
	 */
	public HeadersService(BISServiceCredential serviceCredential, Proxy proxy) {
	...
	public BusinessServiceResponse execute(BusinessServiceRequest businessServiceRequest) throws BISServiceException {
		HeadersServiceRequest request = (HeadersServiceRequest) businessServiceRequest;
		...
		HeadersServiceResponse response = (HeadersServiceResponse) parseResponseToObject(HeadersServiceResponse.class);
		return response;
	}
