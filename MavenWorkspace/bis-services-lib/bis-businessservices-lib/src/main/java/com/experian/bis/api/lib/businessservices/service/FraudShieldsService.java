...
/**
 * <code>FraudShieldsService</code> is the child class of BusinessService
 * Class for building the url and response body
 */
public class FraudShieldsService extends BusinessService{

	private static final String SERVICE_ID = "fraudshields";
	 ...
	 */
	public FraudShieldsService(BISServiceCredential serviceCredential) {
	 ...
	 * @param proxy
	 */
	public FraudShieldsService(Proxy proxy) {
		super(proxy);
	}
	 ...
	 */
	public FraudShieldsService(BISServiceCredential serviceCredential, Proxy proxy) {
	...
	public BusinessServiceResponse execute(BusinessServiceRequest businessServiceRequest) throws BISServiceException {
		FraudShieldsServiceRequest request = (FraudShieldsServiceRequest) businessServiceRequest;
		...
		FraudShieldsServiceResponse response = (FraudShieldsServiceResponse) parseResponseToObject(FraudShieldsServiceResponse.class);
		return response;
	}
